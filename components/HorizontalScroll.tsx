...
const PRODUCTS: ProductItem[] = [
  {
    id: 'prod-01',
    number: '01',
    tag: 'CAPSULE 01 // OVERSIZED',
    kanji: '影',
    title: 'Shadow Silhouette Parka',
    watermark: 'SHADOW',
    price: '$240 USD',
    specs: '500GSM Milled Tech Terry / Heavyweight Drape',
    colorScheme: {
      bg: 'bg-gradient-to-b from-[#0a0a0c] via-[#060608] to-[#040405]',
      accent: 'text-neutral-400',
      badge: 'border-white/20 text-white bg-white/5',
  ...
  },
  {
    id: 'prod-02',
    number: '02',
    tag: 'CAPSULE 02 // ARCHIVAL',
    kanji: '死神',
    title: 'Shinigami Minimal Pullover',
    watermark: 'SHINIGAMI',
    price: '$190 USD',
    specs: 'Discharge Printed Fleece / Raw Cut Detailing',
    colorScheme: {
      bg: 'bg-gradient-to-b from-[#0d0709] via-[#080506] to-[#040405]',
      accent: 'text-rose-400',
      badge: 'border-rose-500/30 text-rose-300 bg-rose-500/10',
      border: 'border-rose-500/20',
    },
    image: '/products/h2.jpg',
  },
  {
    id: 'prod-03',
    number: '03',
    tag: 'CAPSULE 03 // CYBERPUNK',
    kanji: '東京',
    title: 'Neo-Tokyo Tactical Cargo',
    watermark: 'TACTICAL',
    price: '$260 USD',
    specs: 'Water-Repellent Ripstop / Fidlock Magnetic Buckles',
    colorScheme: {
      bg: 'bg-gradient-to-b from-[#060a0e] via-[#04070a] to-[#040405]',
      accent: 'text-cyan-400',
      badge: 'border-cyan-500/30 text-cyan-300 bg-cyan-500/10',
      border: 'border-cyan-500/20',
    },
    image: '/products/h3.jpg',
  },
  {
    id: 'prod-04',
    number: '04',
    tag: 'CAPSULE 04 // DISTRESSED',
    kanji: '虚無',
    title: 'Void Archival Heavy Knit',
    watermark: 'ARCHIVE',
    price: '$210 USD',
    specs: 'Hand-Distressed Ribbed Cotton / Oversized Drop Shoulder',
    colorScheme: {
      bg: 'bg-gradient-to-b from-[#0a0a0a] via-[#060606] to-[#040405]',
      accent: 'text-neutral-300',
      badge: 'border-neutral-400/30 text-neutral-200 bg-neutral-400/10',
      border: 'border-white/10',
    },
    image: '/products/h4.jpg',
  },
  {
    id: 'prod-05',
    number: '05',
    tag: 'CAPSULE 05 // SHELL',
    kanji: '幽霊',
    title: 'Ghost-Shell Cyber Windbreaker',
    watermark: 'ECLIPSE',
    price: '$290 USD',
    specs: 'Reflective 3M Monogram / Dual Vent Storm Flap',
    colorScheme: {
      bg: 'bg-gradient-to-b from-[#0e0a06] via-[#080604] to-[#040405]',
      accent: 'text-amber-400',
      badge: 'border-amber-500/30 text-amber-300 bg-amber-500/10',
      border: 'border-amber-500/20',
    },
    image: '/products/h5.jpg',
  },
];
